function(install_executable target_name)
    ...
    elseif(IOS)
        configure_file(${cmake_utils_PACKAGE_FOLDER_RELEASE}/export_options.plist export_options.plist)
        install(FILES ${CMAKE_CURRENT_BINARY_DIR}/export_options.plist DESTINATION . COMPONENT ${component_name})
        configure_file(${cmake_utils_PACKAGE_FOLDER_RELEASE}/install_ios.cmake install_ios.cmake @ONLY)
